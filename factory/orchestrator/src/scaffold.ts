 ...
 * Deliberately not a person and not a deliverable address: the scaffold commit
 * was authored by a tool, and a later `git log` should say so rather than
 * implicate whoever's laptop happened to run it.
 */
const FALLBACK_IDENTITY = { name: 'black-smith', email: 'black-smith@localhost' };
